...
gpt_deployment = os.getenv("GPT4-1_DEPLOYMENT_NAME")
gpt_mini_deployment = os.getenv("GPT4-1_MINI_DEPLOYMENT_NAME")
api_version = os.getenv("AZURE_OPENAI_API_VERSION")

# Use wide layout for more space and disable initial sidebar
st.set_page_config(page_title="个人助手", page_icon="🤖", layout="wide")

st.markdown("Azure Voice Live API under-construction, please use the [Azure TSP Playground](https://playground.azuretsp.com/) for now.")
